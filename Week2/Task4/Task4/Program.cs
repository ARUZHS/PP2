...
namespace Task4
{
    class Program
    {
        ...
        {
            string path1 = @"C:\Users\aruzh\source\repos\Week2\Task4\text.txt";//записываю путь текстового файла как стринг
            string path2 = @"C:\Users\aruzh\source\repos\Week2\text.txt";//записываю 2 путь того же текстового файла как другой стринг
